...
export default function RegisterForm() {
  ...
  return (
    <div className="flex">
      <form
        className="flex flex-col h-[650px] justify-around mt-16 ml-28"
      ...
      >
        ...
        <div>
          ...
          />
          {errors.lastName && (
            <p className="font-light text-red-600">{errors.lastName.message}</p>
          )}
        </div>
        <div>
          <Label htmlFor="phone">
            Phone:<span className="font-light text-red-600">*</span>
          </Label>
          <Input
            id="phone"
            {...register("phone")}
